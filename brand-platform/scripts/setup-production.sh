...
echo "   MARKETING_SITE_ORIGINS=https://www.cadaapp.org,https://cadaapp.com,https://www.cadaapp.com"
...
echo ""
echo "5. TEST — /api/health then /signup → /dashboard"
echo "   BASE_URL=https://partners.cadaapp.com brand-platform/scripts/test-portal-smoke.sh"
echo ""
echo "   Full checklist: brand-platform/portal/docs/vercel-deploy-checklist.md"
